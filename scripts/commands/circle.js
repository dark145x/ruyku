...
const fs = require("fs");
let pathImg = __dirname + `/cache/circle_${event.senderID}.png`
...
//callback
let canVAS = (
  await axios.get(APIURL + `/api/maker/circle?url=${encodeURIComponent(url)}&apikey=${APIKEY}`, {
